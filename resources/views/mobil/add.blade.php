                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input id="merk_id" name="merk_id" placeholder="merk id"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input id="nopol_id" name="nopol" placeholder="nopol"
                                                                type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input id="Warna_id" name="warna" placeholder="warna"
                                                                type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input id="biayasewa" name="biaya_sewa" placeholder="biaya sewa"
                                                                type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input id="tahun_id" name="tahun" placeholder="tahun "
                                                                type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group">
                                                            ...
                                                            <input id="cc_id" name="cc" placeholder="cc"
                                                                type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
