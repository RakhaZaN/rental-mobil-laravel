...
<body class="img js-fullheight"
    style="background-image: url({{ asset('dist/Registrasi/images/M.jpg') }}); min-height: 100vh;">
    <section class="ftco-section">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        <form action="{{ route('register.store', ['role' => 'public', 'status' => 1]) }}"
                            method="POST">
                            @csrf
        ...
        <option placeholder="User">User</option>
                        ...
                        <div class="form-group">
                            <a href="{{ route('login') }}" class="form-control btn btn-primary submit px-3">I already
                                have a account</a>
                        </div>
    ...
    <script src="{{ asset('dist/Registrasi/js/jquery.min.js') }}"></script>
    <script src="{{ asset('dist/Registrasi/js/popper.js') }}"></script>
    <script src="{{ asset('dist/Registrasi/js/bootstrap.min.js') }}"></script>
